...
export default function Header() {
    ...
    return (
        <header
            className={`fixed top-0 w-full z-50 bg-linear-to-r from-[#0f202793] via-[#203a4393] to-[#2c536493] shadow-sm text-white  transition-all duration-300 
            ...
            <div className={`lg:hidden fixed top-14 right-0 h-screen w-64 bg-[#24424c] shadow-md transition-transform duration-300 ease-in-out z-40 ${clicked ? "translate-x-0" : "translate-x-full"}`}>
